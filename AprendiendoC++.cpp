...
todo 3.5 using namespace std 
para no tener que escribir std:: cada vez. Es como decirle a tu programa: 
"Che, todo lo que este adentro del espacio de nombres std, podes usarlo sin el std::". 
pero tene cuidado al usarlo en proyectos grandes, porque puede causar conflictos de nombres si hay funciones o variables con el mismo nombre en otros espacios de nombres. 
En proyectos chicos o para aprender, esta bien usarlo para simplificar el codigo.
